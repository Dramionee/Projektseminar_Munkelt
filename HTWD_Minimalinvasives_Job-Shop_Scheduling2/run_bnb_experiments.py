...
from src.BnB_Experiment import init_experiment
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate and run BnB experiments from experiments_config.toml in CONFIG_PATH."
    )
    parser.add_argument(
        "--util",
        required=True,
    ...
    # Generate combinations (util × sigma)
...
if __name__ == "__main__":
    """
    Example usage:
    python run_bnb_experiments.py --util 0.75 --sigma 0.1
    python run_bnb_experiments.py --util all --sigma 0.2
    python run_bnb_experiments.py --util all --sigma all
    """
    main()