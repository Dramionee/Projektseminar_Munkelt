...
def plot_gantt(operations):
    ...
    ax.set_title("Job-Shop Gantt-Diagramm Heuristiken_deaktiviert (E4)")
    ax.grid(True, axis="x", linestyle="--", alpha=0.5)
    plt.tight_layout()
    plt.savefig("Bilder/Diagramm Heuristiken_deaktiviert (E4).png", dpi=300)
    print("Diagramm gespeichert als Heuristiken_deaktiviert (E4).png")
...
def plot_memory_usage(memory_log):
    ...
    plt.xlabel("Zeit [s]")
    plt.ylabel("RAM [MB]")
    plt.title("Speicherverbrauch über die Zeit (Branch & Bound) Heuristiken_deaktiviert (E4)")
    plt.grid(True, linestyle="--", alpha=0.5)
    plt.tight_layout()
    plt.savefig("Bilder/Speicher Heuristiken_deaktiviert (E4).png", dpi=300)
    print("Speicherverlauf gespeichert als: Heuristiken_deaktiviert (E4).png")
