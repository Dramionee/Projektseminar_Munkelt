# E0.2 Baseline, Standardkonfiguration, M = 100000 zum Vergleichen als Basis wie größeres M so ist
...
def plot_gantt(operations):
    ...
    plt.tight_layout()
    plt.savefig("Bilder/Diagramm Baseline_alles_standart(E0)2.png", dpi=300)
...
def plot_memory_usage(memory_log):
    ...
    plt.tight_layout()
    plt.savefig("Bilder/Speicher memory_usage_Baseline_alles_standart (E0)2.png", dpi=300)
