# E3 Vergleich, wie Cuts die Schranke und Knotenanzahl beeinflussen
# Variante B&B (Cuts deaktiviert)
...
def plot_gantt(operations):
    ...
    ax.set_title("Job-Shop Gantt-Diagramm Cuts_deaktiviert (E3)")
    ax.grid(True, axis="x", linestyle="--", alpha=0.5)
    plt.tight_layout()
    plt.savefig("Bilder/Diagramm Cuts_deaktiviert (E3).png", dpi=300)
    print("Diagramm gespeichert als Cuts_deaktiviert (E3).png")
...
def plot_memory_usage(memory_log):
    ...
    plt.xlabel("Zeit [s]")
    plt.ylabel("RAM [MB]")
    plt.title("Speicherverbrauch über die Zeit (Branch & Bound) Cuts_deaktiviert (E3)")
    plt.grid(True, linestyle="--", alpha=0.5)
    plt.tight_layout()
    plt.savefig("Bilder/Speicher Cuts_deaktiviert (E3).png", dpi=300)
    print("Speicherverlauf gespeichert als: Cuts_deaktiviert (E3).png")
