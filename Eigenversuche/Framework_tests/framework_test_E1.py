# E1 Test, wie unterschiedliche Big-M Werte die Branch & Bound Performance beeinflussen
# Variante B: m globales sinnvolles M rest stardart
...
def plot_gantt(operations):
    ...
    ax.set_title("Job-Shop Gantt-Diagramm globales_sinnvolles_M (E1)")
    ax.grid(True, axis="x", linestyle="--", alpha=0.5)
    plt.tight_layout()
    plt.savefig("Bilder/Diagramm globales_sinnvolles_M (E1).png", dpi=300)
    print("Diagramm gespeichert als globales_sinnvolles_M (E1).png")
...
def plot_memory_usage(memory_log):
    ...
    plt.xlabel("Zeit [s]")
    plt.ylabel("RAM [MB]")
    plt.title("Speicherverbrauch über die Zeit (Branch & Bound) globales_sinnvolles_M (E1)")
    plt.grid(True, linestyle="--", alpha=0.5)
    plt.tight_layout()
    plt.savefig("Bilder/Speicher globales_sinnvolles_M (E1).png", dpi=300)
    print("Speicherverlauf gespeichert als: memory_usageglobales_sinnvolles_M (E1).png")
